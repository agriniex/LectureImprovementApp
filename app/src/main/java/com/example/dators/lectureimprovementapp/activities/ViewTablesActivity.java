...
import com.example.dators.lectureimprovementapp.helpers.TableFiller;
...
public class ViewTablesActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TableFiller tableFiller = new TableFiller(rootView);
            tableFiller.fillTable(getArguments().getInt(ARG_SECTION_NUMBER));
            return rootView;
        }
    }
